1CLEAR 256,55000:MAXFILES=2:P$="COM:98N1DNN":?"Loading DOS...":S=PEEK(1):IFS=51ORS=167THEND=64704
2IFS=171THEND=63408
3IFS=148THEND=64448:P$="COM:9N81NN"
...
7OPENP$FOROUTPUTAS1:OPENP$FORINPUTAS2:?#1,CHR$(PEEK(1));:I$=INPUT$(1,#2)
8IFI$="1"THENF$="TS-DOS.CO"ELSEIFI$="2"THENF$="TEENY.CO"
9I$=INPUT$(6,#2):L=VAL(I$):IFL=0THEN?"Error opening DOS file!":NEW
